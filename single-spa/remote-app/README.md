...
The microfrontend for checkout in the star wars universe
...
Go to https://localhost:9001/react-mf-checkout.js and verify that you are able to load the file without any SSL problems. To solve SSL problems, see [these instructions](https://improveandrepeat.com/2016/09/allowing-self-signed-certificates-on-localhost-with-chrome-and-firefox/).
